...
export const editDisplayProfile = createTool({
  ...
  description: "Edit an existing display profile.",
  inputSchema: z.object({
    displayProfileId: z.number().describe("The ID of the display profile to edit."),
    name: z.string().describe("The name for the display profile."),
