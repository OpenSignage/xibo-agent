...
export const editDisplayVenue = createTool({
  id: "edit-display-venue",
  description: "会場を編集",
  ...
  execute: async ({ context }) => {
    ...
    const url = new URL(`${config.cmsUrl}/displayvenue/${context.venueId}/edit`);
    ...
    console.log("Display venue edited successfully");
    return validatedData;
  },
});

export default editDisplayVenue; 