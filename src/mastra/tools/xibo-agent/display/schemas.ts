...
export const tagSchema = z.object({
  tag: z.string().nullable().describe('The name of the tag.'),
...
export const displayGroupSchema = z.object({
  ...
  displayGroup: z.string().nullable().describe('The name of the display group.'),
  ...
  dynamicCriteriaLogicalOperator: z.string().nullable().describe('The logical operator for dynamic criteria.'),
  ...
  dynamicCriteriaTagsLogicalOperator: z.string().nullable().describe('The logical operator for dynamic tag criteria.'),
  ...
  createdDt: z.string().nullable().describe('The creation date of the group.'),
  modifiedDt: z.string().nullable().describe('The last modification date of the group.'),
...
export const displaySchema = z.object({
  ...
  address: z.string().nullable().describe('The physical address of the display.'),
  isMobile: z.number().describe('Flag indicating if the display is mobile.'),
  languages: z.string().nullable().describe('Languages supported by the display.'),
  displayType: z.string().nullable().describe('The type of the display.'),
  screenSize: z.number().describe('The screen size.'),
  isOutdoor: z.number().describe('Flag indicating if the display is outdoors.'),
  customId: z.string().nullable().describe('A custom identifier for the display.'),
  ...
  display: z.string().nullable().describe('The name of the display.'),
  description: z.string().nullable().describe('A description for the display.'),
  defaultLayoutId: z.number().describe('The ID of the default layout.'),
  license: z.string().nullable().describe('The license key for the display.'),
  ...
  clientAddress: z.string().nullable().describe('The IP address of the client.'),
  ...
  wakeOnLanTime: z.string().nullable().describe('The time for WoL.'),
  broadCastAddress: z.string().nullable().describe('The broadcast address for WoL.'),
  secureOn: z.string().nullable().describe('SecureOn settings.'),
  cidr: z.string().nullable().describe('CIDR notation for the network.'),
  ...
  clientType: z.string().nullable().describe('The type of the client software.'),
  clientVersion: z.string().nullable().describe('The version of the client software.'),
  ...
  currentLayout: z.string().nullable().describe('The name of the current layout.'),
  ...
  xmrChannel: z.string().nullable().describe('The XMR channel for real-time communication.'),
  xmrPubKey: z.string().nullable().describe('The XMR public key.'),
  lastCommandSuccess: z.number().describe('Timestamp of the last successful command.'),
  deviceName: z.string().nullable().describe('The name of the device.'),
  timeZone: z.string().nullable().describe('The time zone of the display.'),
  tags: z.array(tagSchema).describe('An array of tags associated with the display.'),
  overrideConfig: z.string().nullable().describe('JSON string for overriding configuration.'),
  bandwidthLimit: z.number().describe('The bandwidth limit for the display.'),
  newCmsAddress: z.string().nullable().describe('A new CMS address for redirection.'),
  newCmsKey: z.string().nullable().describe('A new CMS key for redirection.'),
  orientation: z.string().nullable().describe('The screen orientation.'),
  resolution: z.string().nullable().describe('The screen resolution.'),
  commercialLicence: z.number().describe('Flag for commercial license.'),
  teamViewerSerial: z.string().nullable().describe('The TeamViewer serial number.'),
  webkeySerial: z.string().nullable().describe('The Webkey serial number.'),
  groupsWithPermissions: z.string().nullable().describe('Permissions for the groups.'),
  createdDt: z.string().nullable().describe('The creation date of the display.'),
  modifiedDt: z.string().nullable().describe('The last modification date of the display.'),
  ...
  lanIpAddress: z.string().nullable().describe('The LAN IP address of the display.'),
  syncGroupId: z.number().describe('The ID of the sync group.'),
  osVersion: z.string().nullable().describe('The operating system version.'),
  osSdk: z.string().nullable().describe('The operating system SDK version.'),
  manufacturer: z.string().nullable().describe('The manufacturer of the device.'),
  brand: z.string().nullable().describe('The brand of the device.'),
  model: z.string().nullable().describe('The model of the device.'),
}); 