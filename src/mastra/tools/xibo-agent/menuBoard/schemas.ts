...
export const menuBoardSchema = z.object({
  ...
  description: z.string().nullable().optional().describe('An optional description for the menu board.'),
  code: z.string().nullable().optional().describe('An optional code for the menu board.'),
...
export const menuBoardCategorySchema = z.object({
  ...
  description: z.string().nullable().optional().describe('An optional description for the category.'),
  code: z.string().nullable().optional().describe('An optional code for the category.'),
  mediaId: z.number().nullable().optional().describe('The ID of the media associated with the category.'),
});
...
export const menuBoardProductSchema = z.object({
  ...
  price: z.number().nullable().optional().describe('The price of the product.'),
  description: z.string().nullable().optional().describe('An optional description for the product.'),
  code: z.string().nullable().optional().describe('An optional code for the product.'),
  displayOrder: z.number().describe('The display order of the product.'),
  availability: z.number().nullable().optional().describe('Flag indicating product availability.'),
  allergyInfo: z.string().nullable().optional().describe('Allergy information for the product.'),
  calories: z.number().nullable().optional().describe('Calorie count for the product.'),
  mediaId: z.number().nullable().optional().describe('The ID of the media associated with the product.'),
  productOptions: z.array(z.string()).nullable().optional().describe('An array of product options.'),
}); 