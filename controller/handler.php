...
try {
    ...
    if (!file_exists(__DIR__ . '/../config/config.php')) {
        throw new Exception('設定ファイルが見つかりません: ' . __DIR__ . '/../config/config.php');
    }
    ...
    // エージェント処理ロジックを読み込み
    if (!file_exists(__DIR__ . '/../controller/agent.php')) {
        throw new Exception('エージェントライブラリが見つかりません: ' . __DIR__ . '/../controller/agent.php');
    }
